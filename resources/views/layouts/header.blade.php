    ...
    <div class="container h-100" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        <div class="d-flex align-items-center justify-content-between h-100">
            ...
            <nav class="d-none d-lg-block">
                <ul style="display: flex; gap: 25px; margin: 0; padding: 0; list-style: none;">
            ...
            <div class="d-flex align-items-center gap-3">
                <button class="th-menu-toggle d-inline-block d-lg-none mobile-menu-toggle" style="background: none; border: none; font-size: 20px; color: #333; cursor: pointer;">
